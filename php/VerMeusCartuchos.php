...
<body>
    ...
    if (isset($_GET)) {
        ...
        $sql = "SELECT DISTINCT * FROM cartucho WHERE " . $escolhaPesquisa . " LIKE '%" . $buscaCartucho . "%' && usuario = " . $cpf . " ORDER BY ano " . $filtro . ";";
